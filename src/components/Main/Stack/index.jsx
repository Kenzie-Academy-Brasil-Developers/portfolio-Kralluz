...
import { SiNestjs, SiStyledcomponents, SiJavascript, SiTypescript, SiDjango, SiExpress, SiNextdotjs } from "react-icons/si";
    ...
    return (
        <>
            ...
            >
                <SwiperSlide>
                    <div>
                        <SiJavascript size={40} style={{ fill: "#F7E018" }} />
                        <h6>JavaScript</h6>
                    </div>
                </SwiperSlide>
                <SwiperSlide>
                    <div>
                        <SiTypescript size={40} style={{ fill: "#3075C1" }} />
                        <h6>TypeScript</h6>
                    </div>
                </SwiperSlide>
                <SwiperSlide>
                ...
                <SwiperSlide>
                    <div>
                        <FaBootstrap size={40} style={{ fill: "#8812FB" }} />
                        <h6>Bootstrap</h6>
                    </div>
                </SwiperSlide>
                <SwiperSlide>
